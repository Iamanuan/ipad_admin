...
<template>
  <div class="set_container">
    ...
    <el-dialog
     ...
     width="30%" 
     top="20vh">
      <el-form :rules="updatePwdFormRules" ref="updatePwdFormRef" :model="pwdForm">
        <el-form-item label="当前密码" label-width="120px" prop="originPwd">
          <el-input v-model="pwdForm.originPwd" clearable></el-input>
        </el-form-item>
        <el-form-item label="新密码" label-width="120px" prop="newPwd">
          <el-input v-model="pwdForm.newPwd" clearable></el-input>
        </el-form-item>
        <el-form-item label="重复新密码" label-width="120px" prop="againPwd">
  ...
  methods: {
    ...
    updatePassword() {
      this.$refs.updatePwdFormRef.validate(async valid => {
        ...
        if (res.status === 400) return this.$message.error("修改密码失败！")
