     ...
     :model="password">
      <el-form :rules="updatePwdFormRules">
        <el-form-item label="当前密码" label-width="120px" prop="originPwd">
          <el-input v-model="password.originPwd"></el-input>
        </el-form-item>
        <el-form-item label="新密码" label-width="120px" prop="originPwd">
          <el-input v-model="password.newPwd"></el-input>
        </el-form-item>
        <el-form-item label="重复新密码" label-width="120px" prop="originPwd">
          <el-input></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer">
  ...
  data() {
    return {
      ...
      updatePwdFormRules:{
        // 为空验证
        originPwd: [
          { required: true, message: '当前密码不能为空1111', trigger: 'blur' },
        ],
        newPwd:[
